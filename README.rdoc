...
=== Basic
  ...
  secret_key = Digest::SHA256.hexdigest("#{secret_key}_#{salt}")
  iv = (OpenSSL::Cipher::Cipher.new('aes-256-cbc').random_iv
  encrypted_value = Encryptor.encrypt('some string to encrypt', :key => secret_key, :iv => iv) # '������{)��q�ށ�ܣ��q���Au/�ޜP'
...
The value to encrypt or decrypt may also be passed as the <tt>:value</tt> option if you'd like.
  ...
  encrypted_value = Encryptor.encrypt(:value => 'some string to encrypt', :key => secret_key, :iv => iv) # '������{)��q�ށ�ܣ��q���Au/�ޜP'
  decrypted_value = Encryptor.decrypt(:value => encrypted_value, :key => secret_key, :iv => iv) # 'some string to encrypt'
